...
**Overall best MASE**: 0.0242 (LC weight = 1.0e-06, obs_noise_scale = 0.00)
**Overall best traj loss**: 0.00000 at epoch 187.0
**Runs analyzed**: 9
...
n_dims=100, n_latent=100, n_dyn=7, dt=0.0150
  run=c298q1ql: DiagnosticMetrics(one_step_mase=0.01902610808610916, loop_closure_loss=7.285726547241211, fast_eigenvalue_fraction=0.0, trajectory_val_loss=2.005813485084218e-06) (from W&B history)
  run=7lisffbx: DiagnosticMetrics(one_step_mase=0.01849205046892166, loop_closure_loss=0.6294549703598022, fast_eigenvalue_fraction=0.0, trajectory_val_loss=2.1704354367102496e-06) (from W&B history)
  run=nf98ywkc: DiagnosticMetrics(one_step_mase=0.018185092136263847, loop_closure_loss=0.11640094965696335, fast_eigenvalue_fraction=0.0, trajectory_val_loss=2.3759848772897385e-06) (from W&B history)
  run=5e7er73b: DiagnosticMetrics(one_step_mase=0.018947875127196312, loop_closure_loss=0.011254142969846725, fast_eigenvalue_fraction=0.0, trajectory_val_loss=2.662514816620387e-06) (from W&B history)
  run=au3g4drn: DiagnosticMetrics(one_step_mase=0.01906902901828289, loop_closure_loss=0.0010725540341809392, fast_eigenvalue_fraction=0.0, trajectory_val_loss=1.8616602801557747e-06) (from W&B history)
  run=3mf5lbdk: DiagnosticMetrics(one_step_mase=0.024641312658786774, loop_closure_loss=0.00014135209494270384, fast_eigenvalue_fraction=0.0, trajectory_val_loss=5.010381755710114e-06) (from W&B history)
  run=q22g51rj: DiagnosticMetrics(one_step_mase=0.022889820858836174, loop_closure_loss=6.498147740785498e-06, fast_eigenvalue_fraction=0.0, trajectory_val_loss=9.684760698291939e-06) (from W&B history)
  run=xmuw8ps6: DiagnosticMetrics(one_step_mase=0.026089906692504883, loop_closure_loss=1.309115646108694e-06, fast_eigenvalue_fraction=0.0, trajectory_val_loss=1.8657865439308807e-05) (from W&B history)
  run=eyo7g55k: DiagnosticMetrics(one_step_mase=0.04986768588423729, loop_closure_loss=2.005633170654164e-08, fast_eigenvalue_fraction=0.0, trajectory_val_loss=2.7161015168530867e-05) (from W&B history)
