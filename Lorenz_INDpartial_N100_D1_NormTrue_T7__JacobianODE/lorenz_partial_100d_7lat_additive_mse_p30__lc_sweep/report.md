...
n_dims=100, n_latent=100, n_dyn=7, dt=0.0150
  run=9xnjqjmp: DiagnosticMetrics(one_step_mase=0.08590328693389893, loop_closure_loss=1.4116860628128052, fast_eigenvalue_fraction=0.0, trajectory_val_loss=5.843710096087307e-05) (from W&B history)
  run=awa884vs: DiagnosticMetrics(one_step_mase=0.07256656140089035, loop_closure_loss=1.245060682296753, fast_eigenvalue_fraction=0.0, trajectory_val_loss=5.9367011999711394e-05) (from W&B history)
  run=2du17wmt: DiagnosticMetrics(one_step_mase=0.09526988118886948, loop_closure_loss=0.412641704082489, fast_eigenvalue_fraction=0.0, trajectory_val_loss=6.370167102431878e-05) (from W&B history)
  run=zkjscsm3: DiagnosticMetrics(one_step_mase=0.055645253509283066, loop_closure_loss=0.07005464285612106, fast_eigenvalue_fraction=0.0, trajectory_val_loss=7.488905248465016e-05) (from W&B history)
  run=lvr4wawa: DiagnosticMetrics(one_step_mase=0.07911882549524307, loop_closure_loss=0.008914769627153873, fast_eigenvalue_fraction=0.0, trajectory_val_loss=0.00013317209959495813) (from W&B history)
  run=yb5zx52m: DiagnosticMetrics(one_step_mase=0.07385517656803131, loop_closure_loss=0.00191215006634593, fast_eigenvalue_fraction=0.0, trajectory_val_loss=0.0003150587435811758) (from W&B history)
  run=2pcaimda: DiagnosticMetrics(one_step_mase=0.1133987307548523, loop_closure_loss=0.0001458602346247062, fast_eigenvalue_fraction=0.0, trajectory_val_loss=0.0003237242344766855) (from W&B history)
  run=m31ywv0g: DiagnosticMetrics(one_step_mase=0.2804737985134125, loop_closure_loss=2.9577699024230242e-05, fast_eigenvalue_fraction=0.0, trajectory_val_loss=0.0008164768805727363) (from W&B history)
  run=idz7flku: DiagnosticMetrics(one_step_mase=0.22761313617229462, loop_closure_loss=2.5641359115979867e-06, fast_eigenvalue_fraction=0.0, trajectory_val_loss=0.0008632524404674768) (from W&B history)
