...
**Chosen run** (by `best_traj_loss`): `i70i2ohj` — traj_loss=0.00006, MASE=0.0484, R²=0.9999, LC loss=0.700, epoch=189.0

Swept-axis values at chosen run: `training.lightning.loop_closure_weight`=1.0e-06

### Integrity checks

⚠️ **9 run_idx slot(s) had multiple matching wandb runs** — the best by `best_traj_loss` was kept; the others are listed below for audit:
  - run_idx=**0**: chose `uc88439u`, dropped `aopmtsoq`, `4j6c5vve`
  - run_idx=**1**: chose `i70i2ohj`, dropped `yzwnzk9t`, `vsosz9mk`
  - run_idx=**2**: chose `r4e2tz1t`, dropped `fi793v6w`
  - run_idx=**3**: chose `v28ch8gy`, dropped `ke7ftm7p`
  - run_idx=**4**: chose `gd9tq34d`, dropped `jox27btm`
  - run_idx=**5**: chose `ylg3k1nq`, dropped `p3fum1ns`
  - run_idx=**6**: chose `4jdgwp4t`, dropped `tkb16u0a`, `59if6tin`, `mif0flvc`
  - run_idx=**7**: chose `s0nxbdcm`, dropped `okwm9dc3`
  - run_idx=**8**: chose `lv34e288`, dropped `uzugag1g`
...
|---|---|---|---|---|---|---|---|
| 1 | `i70i2ohj` | 1.0e-06 | 0.00006 | 0.0484 | 0.9999 | 0.700 | 189.0 |
| 2 | `r4e2tz1t` | 1.0e-05 | 0.00006 | 0.0506 | 0.9999 | 0.306 | 190.0 |
| 3 | `v28ch8gy` | 1.0e-04 | 0.00007 | 0.0560 | 0.9999 | 0.038 | 189.0 |
| 0 | `uc88439u` | 0 | 0.00007 | 0.0580 | 0.9999 | 0.845 | 140.0 |
| 4 | `gd9tq34d` | 0.001 | 0.00009 | 0.0709 | 0.9999 | 0.006 | 147.0 |
| 6 | `4jdgwp4t` | 0.1 | 0.00011 | 0.1061 | 0.9999 | 0.000 | 191.0 |
| 7 | `s0nxbdcm` | 1 | 0.00012 | 0.1132 | 0.9999 | 0.000 | 163.0 |
| 5 | `ylg3k1nq` | 0.01 | 0.00019 | 0.1340 | 0.9998 | 0.002 | 77.0 |
| 8 | `lv34e288` | 10 | 0.00368 | 0.9307 | 0.9958 | 0.000 | 76.0 |
...
Entropy-based utilization: 0.709
Null subspace mean RMS: 1.272254e+00
...
Empirical Lyapunov exponents (mean ± std):
  ...
  λ_2 = -0.1016 ± 0.0797
  λ_3 = -13.8370 ± 0.0514
Mean KY dim (predicted): 1.134 ± 0.040
Mean KY dim (empirical): 2.012 ± 0.003
Mean KY dim (burn-in):   1.502 ± 0.549
...
Amplification loss — Latent:     0.000033
```
