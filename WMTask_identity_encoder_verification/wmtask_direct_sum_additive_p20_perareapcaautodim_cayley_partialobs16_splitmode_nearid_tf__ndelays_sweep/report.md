...
| run_idx | run_id | `data.postprocessing.generalized_variance` | `data.train_test_params.delay_embedding_params.n_delays` | `model.n_target_dims` | `model.n_target_dims_per_block_pca_auto` | `model.n_target_dims_per_block_pca_cum_var` | `model.params.input_dim` | `model.params.output_dim` | best_traj_loss | best_MASE | R² | LC loss | epoch |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 3 | `po289iaq` | 0.0197462 | 9 | 30 | [17, 13] | [0.9905957045468436, 0.99105788566372] | 30 | 900 | 0.00338 | 0.5917 | 0.9960 | 95.229 | 38.0 |
| 4 | `wxe7sas1` | 0.0197462 | 12 | 33 | [19, 14] | [0.990466904603792, 0.9907145482737882] | 33 | 1089 | 0.00339 | 0.5974 | 0.9958 | 100.536 | 41.0 |
| 2 | `6leje1og` | 0.0197462 | 6 | 25 | [14, 11] | [0.9903351849713868, 0.9900285479042218] | 25 | 625 | 0.00347 | 0.6000 | 0.9958 | 91.043 | 32.0 |
| 1 | `szp2jnl3` | 0.0197462 | 3 | 22 | [12, 10] | [0.9904783175511908, 0.9908902223205168] | 22 | 484 | 0.00373 | 0.6141 | 0.9954 | 66.328 | 32.0 |
| 5 | `d4keeqjj` | 0.0197462 | 15 | 35 | [20, 15] | [0.9900060728622276, 0.9905745947396116] | 35 | 1225 | 0.00387 | 0.6355 | 0.9954 | 116.830 | 58.0 |
| 0 | `1mi9tvq3` | 0.0197462 | 1 | 21 | [11, 10] | [0.9930656977806188, 0.9926789277872394] | 21 | 441 | 0.00488 | 0.6995 | 0.9940 | 46.491 | 34.0 |
