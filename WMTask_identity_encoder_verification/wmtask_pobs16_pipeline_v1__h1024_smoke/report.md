# Sweep Analysis: `wmtask_pobs16_pipeline_v1__h1024_smoke`

**Project**: [WMTask_identity_encoder_verification](https://wandb.ai/JacobianODE/WMTask_identity_encoder_verification/groups/wmtask_pobs16_pipeline_v1__h1024_smoke)  
**Launched**: 2026-05-05T05:50:45Z  
**Completed**: 2026-05-05T06:00:50Z  
...
### `wmtask_pobs16_pipeline_v1__h1024_smoke`

**Description**

Smoke test for the H=1024 encoder (vs the H=128 scout default).
1 cell, n_delays=15 (worst-case Cayley memory at D=240 per area),
5 train batches, 2 val batches, 1 epoch. ou_bcs_high (H100s).

**Hypothesis**

H=1024 fits on a single H100 without OOM. Should finish in well
under the 30-min walltime cap I'm asking for.

**Success criteria**

- Job COMPLETES (no OOM, no NaN train loss)
- 5 train batches + 2 val batches logged to wandb

## Results

**Chosen run** (by `best_traj_loss`): `6adererk` — traj_loss=1.26580, MASE=8.3269, R²=-0.3305, LC loss=0.006, epoch=0.0
...
|---|---|---|---|---|---|---|
| 0 | `6adererk` | 1.26580 | 8.3269 | -0.3305 | 0.006 | — |

## Success-criteria verdicts (automated)

| Criterion | Verdict | Note |
|---|---|---|
| Job COMPLETES (no OOM, no NaN train loss) | **Unknown** |  |
| 5 train batches + 2 val batches logged to wandb | **Unknown** |  |
...
```
No run_id provided — selecting best run from group 'wmtask_pobs16_pipeline_v1__h1024_smoke' ...
Found 1 total runs in JacobianODE/WMTask_identity_encoder_verification (group=wmtask_pobs16_pipeline_v1__h1024_smoke)
All runs (state, loop_closure_weight, tangent_entropy_weight, kl_dyn_weight):
  6adererk: state=finished, lc=0.0, te=0.0, kl_dyn=0.0

slurm_timeout_min not found in any run config — falling back to 180 min
  Including 6adererk (lc=0.0): use_all_runs=True (state=finished)
Found 1 effectively-done sweep runs:
  loop_closure_weight=0.0, tangent_entropy_weight=0.0, kl_dyn_weight=0.0 -> run_id=6adererk
...
n_dims=480, n_latent=480, n_dyn=41, dt=0.0200
  run=6adererk: DiagnosticMetrics(one_step_mase=7.459267616271973, loop_closure_loss=0.005563513375818729, fast_eigenvalue_fraction=0.0, trajectory_val_loss=1.2657999992370605) (from W&B history)

Ranking method:           best_traj_loss
Best run ID:              6adererk
Best loop_closure_weight: 0.0
Best tangent_entropy_weight: 0.0
Best kl_dyn_weight:       0.0
Best traj loss:           1.265800
Criteria applied: ['C3']
Surviving: 1 / 1
Auto-selected run_id: 6adererk
...
======================================================================
  ...
  ------------  --------------  --------------
  6adererk            0.005564        1.265800 <-- selected
...
======================================================================
  ...
  ----------------------  ------------  --------------  --------------
  best_traj_loss          6adererk            0.005564        1.265800 <-- active
  pareto_knee             6adererk            0.005564        1.265800
  geo_rank                6adererk            0.005564        1.265800
  minimax_rank            6adererk            0.005564        1.265800
  geo_log_score           6adererk            0.005564        1.265800
  minimax_log_score       6adererk            0.005564        1.265800
======================================================================

Loading run 6adererk from JacobianODE/WMTask_identity_encoder_verification ...
loaded wmtask RNN model checkpoint 1
Loading cached wmtask hiddens from /orcd/data/ekmiller/001/eisenaj/ControlJacobians/WMTaskModels/WMSelectionTask__cue_time_0.1__response_time_0.25__enforce_fixation_False/BiologicalRNN__cue_time_0.1__learning_rate_0.0005__max_epochs_42__N1_64__N2_64__tau_0.05__dt_0.02__eig_lower_bound_0.1__init_mode_random/_jacobianode_cache/hiddens__all__epoch1__trials4096__seed42.pt
loaded wmtask RNN model checkpoint 41
Loading cached wmtask hiddens from /orcd/data/ekmiller/001/eisenaj/ControlJacobians/WMTaskModels/WMSelectionTask__cue_time_0.1__response_time_0.25__enforce_fixation_False/BiologicalRNN__cue_time_0.1__learning_rate_0.0005__max_epochs_42__N1_64__N2_64__tau_0.05__dt_0.02__eig_lower_bound_0.1__init_mode_random/_jacobianode_cache/hiddens__all__epoch41__trials4096__seed42.pt
Loading checkpoint epoch=0-step=2.ckpt...
Loading checkpoint epoch=0-step=2.ckpt...
Computing reconstruction ...
Computing MASE ...
Teacher-forced MASE: 7.3690
Free-running MASE:   7.9887
Computing latent utilization ...
Entropy-based utilization: 0.870
Null subspace mean RMS: 9.651920e-01
...
Mean KY dim (predicted): 29.964 ± 0.894
Mean KY dim (empirical): 0.056 ± 0.249
Mean KY dim (burn-in):   29.964 ± 0.894
Computing prediction windows ...
Windows: 3 — nMSE min=3.6073, median=3.7546, mean=3.9015, max=4.3425
...
Amplification loss — Latent:     0.005357
