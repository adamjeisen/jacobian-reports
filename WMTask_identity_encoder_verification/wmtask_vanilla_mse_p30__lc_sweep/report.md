...
Mean KY dim (predicted): 0.237 ± 0.468
...
--- backfill 2026-04-16T04:46:14Z sections=['reconstruction', 'latent_utilization', 'kaplan_yorke', 'prediction_detail', 'long_trajectory', 'encoder_decoder_jacobians', 'amplification'] ---
No run_id provided — selecting best run from group 'wmtask_vanilla_mse_p30__lc_sweep' ...
Found 9 total runs in JacobianODE/WMTask_identity_encoder_verification (group=wmtask_vanilla_mse_p30__lc_sweep)
All runs (state, loop_closure_weight, tangent_entropy_weight, kl_dyn_weight):
  bi75wfwx: state=finished, lc=1e-05, te=0.0, kl_dyn=0.0
