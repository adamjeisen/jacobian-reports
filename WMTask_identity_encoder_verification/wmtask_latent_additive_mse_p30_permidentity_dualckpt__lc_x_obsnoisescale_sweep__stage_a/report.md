# Sweep Analysis: `wmtask_latent_additive_mse_p30_permidentity_dualckpt__lc_x_obsnoisescale_sweep__stage_a`

**Project**: [WMTask_identity_encoder_verification](https://wandb.ai/JacobianODE/WMTask_identity_encoder_verification/groups/wmtask_latent_additive_mse_p30_permidentity_dualckpt__lc_x_obsnoisescale_sweep__stage_a)  
...
|---|---|---|---|---|---|---|---|---|---|
| 5 | `blxnhdbm` | 0.00954705 | 1.0e-06 | 0.05 | 0.00494 | 0.6817 | 0.9943 | 15.131 | 19.0 |
| 2 | `9lr5pj1o` | 0.00954705 | 0 | 0.05 | 0.00495 | 0.6821 | 0.9943 | 22.925 | 19.0 |
| 8 | `euyeqm0p` | 0.00954705 | 1.0e-05 | 0.05 | 0.00498 | 0.6849 | 0.9943 | 5.223 | 19.0 |
| 3 | `0pkgerj8` | 0.00954705 | 1.0e-06 | 0 | 0.00515 | 0.6953 | 0.9941 | 8.117 | 19.0 |
| 0 | `hgbqcq47` | 0.00954705 | 0 | 0 | 0.00515 | 0.6954 | 0.9941 | 12.271 | 19.0 |
| 6 | `tgad1rh4` | 0.00954705 | 1.0e-05 | 0 | 0.00524 | 0.7008 | 0.9940 | 2.897 | 19.0 |
| 4 | `v0viph3w` | 0.00954705 | 1.0e-06 | 0.01 | 0.00545 | 0.7153 | 0.9937 | 10.302 | 19.0 |
| 1 | `k21dhcz5` | 0.00954705 | 0 | 0.01 | 0.00545 | 0.7154 | 0.9937 | 15.297 | 19.0 |
| 11 | `597khda3` | 0.00954705 | 1.0e-04 | 0.05 | 0.00548 | 0.7170 | 0.9937 | 1.155 | 19.0 |
| 7 | `nviyshra` | 0.00954705 | 1.0e-05 | 0.01 | 0.00555 | 0.7218 | 0.9936 | 3.927 | 19.0 |
| 9 | `hoom9le2` | 0.00954705 | 1.0e-04 | 0 | 0.00573 | 0.7281 | 0.9934 | 0.594 | 19.0 |
| 10 | `sb14ds5j` | 0.00954705 | 1.0e-04 | 0.01 | 0.00622 | 0.7640 | 0.9929 | 0.865 | 19.0 |
| 12 | `7s7274d9` | 0.00954705 | 0.001 | 0 | 0.00734 | 0.8106 | 0.9916 | 0.060 | 19.0 |
| 14 | `p6uhejdt` | 0.00954705 | 0.001 | 0.05 | 0.01070 | 0.9751 | 0.9878 | 0.369 | 19.0 |
| 15 | `910gcule` | 0.00954705 | 0.01 | 0 | 0.01148 | 0.9827 | 0.9869 | 0.003 | 19.0 |
| 13 | `97gwil2h` | 0.00954705 | 0.001 | 0.01 | 0.01510 | 1.1592 | 0.9827 | 0.461 | 19.0 |
| 18 | `j3scd22n` | 0.00954705 | 0.1 | 0 | 0.01901 | 1.2222 | 0.9782 | 0.000 | 19.0 |
| 20 | `8wenpb2v` | 0.00954705 | 0.1 | 0.05 | 0.03266 | 1.6331 | 0.9626 | 0.003 | 19.0 |
| 19 | `6at90qw8` | 0.00954705 | 0.1 | 0.01 | 0.03808 | 1.7582 | 0.9563 | 0.003 | 19.0 |
| 16 | `drptqjrh` | 0.00954705 | 0.01 | 0.01 | 0.04633 | 1.9172 | 0.9470 | 0.012 | 8.0 |
| 17 | `ed66rwm9` | 0.00954705 | 0.01 | 0.05 | 0.05065 | 1.9566 | 0.9422 | 0.013 | 5.0 |
...
```
No run_id provided — selecting best run from group 'wmtask_latent_additive_mse_p30_permidentity_dualckpt__lc_x_obsnoisescale_sweep__stage_a' ...
